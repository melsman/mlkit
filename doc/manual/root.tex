...
\begin{verbatim}
 rp2ps -region -name life -sampleMax 80 -eps 138 mm
\end{verbatim}
The option \boxml{-eps 138 mm} has the effect that \boxml{region.ps}
...
file \boxml{region.ps} can be generated by the unix command
