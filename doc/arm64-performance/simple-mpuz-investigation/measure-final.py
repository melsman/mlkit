...
for name,variants in [('simple',['x64','arm64','combined']),('mpuz',['x64','arm64','branch-all','branch-all-loads'])]:
 ...
 (r/'final-measurements.json').write_text(json.dumps(results,indent=2)+'\n')
