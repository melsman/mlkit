...
r=Path('/private/tmp/mlkit-msort');exes={'shared-head':r/'shared-head.exe','arm64':r/'arm64.exe','x64':r/'x64.exe'};out={k:[] for k in exes};rng=random.Random(223)
...
(r/'shared-head-measurements.json').write_text(json.dumps(out,indent=2)+'\n')
