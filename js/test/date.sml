...
val _ = print "<h2>File date.sml: Testing structure Date...</h2>"

local
    open Time Date
    fun later h =
	toString(fromTimeLocal(now() + fromReal (3600.0 * real h))) ^ "<br/>";
...
val _ =
    ((*print "This is (local time) now:        "; print (later 0);
     ...
     print (toString (fromTimeUniv(now()))); print "<br/>";
     ...
     print (toString(fromTimeUniv zeroTime) ^ "<br/>");
     print "The UTC millenium (UTC time):    ";
     print (toString y2k ^ "<br/>");
...
(*
     ...
     print (toString (fromTimeLocal (toTime y2k)) ^ "<br/>");
     ...
     print (toString (fromTimeUniv (toTime y2kE1)) ^ "<br/>");
     print "The UTC-01 millenium (UTC):      ";
     print (toString (fromTimeUniv (toTime y2kW1)) ^ "<br/>");
     print "This is today's number:          ";
     print (fmt "%j" (nowdate()) ^ " (internally: ");
     print (Int.toString (yearDay (nowdate())) ^ ")<br/>");
     print "This is today's weekday:         ";
     print (fmt "%A" (nowdate()) ^ "<br/>");
     print "This is the name of this month:  ";
     print (fmt "%B" (nowdate()) ^ "<br/>");
     print "Today's ISO date:                ";
     print (fmt "%Y-%m-%d" (nowdate ()) ^ "<br/>")*)())
