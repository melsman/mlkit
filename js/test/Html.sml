(* Html.sml -- HTML combinators; based on Peter Sestoft's Msp implementation...
...
fun printhtml Empty      = ()
  | printhtml Nl         = print "\n"
  | printhtml ($ s)      = print s
  | printhtml ($$ ss)    = List.app print ss
  | printhtml (s1 && s2) = (printhtml s1; printhtml s2);
...
(* Maybe this should create html instead, to avoid creating a long 
