...
val _ = print ("<html></head></head><body><h1>Timer frp ex1</h1>" ^
               ...
               "<span id='over'>Test this</span> -> <span id='overres'>?</span> (<span id='count'>?</span>)" ^
...
val ct : (bool,string,B)arr = fold (fn (true,n) => n+1 | (false,n) => n) 0 >>> arr Int.toString

val _ = insertDOM(ct ob, "count")
...
val bc : (int,B)t = fold (fn (Up,a) => a + 1
                           | (Down,a) => a - 1) 0 es
