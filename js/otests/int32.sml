(* File int32.sml: Testing Int32 operations.
...
val _ = tstStart "structure Int32"
...
val test23b = tst' "test23b" (fn _ => scanFmt StringCvt.DEC (valOf Int32.maxInt));
val test23c = tst' "test23c" (fn _ => scanFmt StringCvt.OCT (valOf Int32.maxInt));
val test23d = tst' "test23d" (fn _ => scanFmt StringCvt.BIN (valOf Int32.maxInt));

val test24a = tst' "test24a" (fn _ => scanFmt StringCvt.HEX (valOf Int32.minInt));
val test24b = tst' "test24b" (fn _ => scanFmt StringCvt.DEC (valOf Int32.minInt));
val test24c = tst' "test24c" (fn _ => scanFmt StringCvt.OCT (valOf Int32.minInt));
val test24d = tst' "test24d" (fn _ => scanFmt StringCvt.BIN (valOf Int32.minInt));

val test25a = tst' "test25a" (fn _ => scanFmt StringCvt.HEX (valOf Int32.minInt + 10));
val test25b = tst' "test25b" (fn _ => scanFmt StringCvt.DEC (valOf Int32.minInt + 10));
