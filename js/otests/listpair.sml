(* File listpair.sml: Testing ListPair operations.
 * Copyright (c) 1994-2014, Peter Sestoft, Martin Elsman.
 * MIT License.
 *)

open Utest
val _ = tstStart "structure ListPair"
...
val test3b = (reset (); map (incrv o #1) (a, b); (); checkv());
...
val test5d = (reset(); all (fn (x,y) => (incrv x; true)) (a, b); 
              checkv());
val test5e = (reset(); exists (fn (x,y) => (incrv x; false)) (a, b); 
              checkv());
