(* File string.sml: Testing String operations.
 * Copyright (c) 1994-2014, Peter Sestoft, Martin Elsman.
 * MIT License.
 *)

open Utest
val _ = tstStart "structure String"
...
val test3 = tst0 "test3" ((sub(s1, 0); "WRONG") handle Subscript => "OK" | _ => "WRONG");
val test4 = tst0 "test4" ((sub(s2, ~1); "WRONG") handle Subscript => "OK" | _ => "WRONG");
val test5 = tst0 "test5" ((sub(s2, 10); "WRONG") handle Subscript => "OK" | _ => "WRONG");
...
val test11b = tst0 "test11b" ((extract(s2, ~1, SOME 0); "WRONG") 
			      handle Subscript => "OK" | _ => "WRONG");
val test11c = tst0 "test11c" ((extract(s2, 11, SOME 0); "WRONG") 
			      handle Subscript => "OK" | _ => "WRONG");
val test11d = tst0 "test11d" ((extract(s2, 0, SOME 11); "WRONG") 
			      handle Subscript => "OK" | _ => "WRONG");
val test11e = tst0 "test11e" ((extract(s2, 10, SOME 1); "WRONG") 
			      handle Subscript => "OK" | _ => "WRONG");
val test11f = tst0 "test11f" ((extract(s2, ~1, NONE); "WRONG") 
			      handle Subscript => "OK" | _ => "WRONG");
val test11g = tst0 "test11g" ((extract(s2, 11, NONE); "WRONG") 
			      handle Subscript => "OK" | _ => "WRONG");
...
val test12b = tst0 "test12b" ((substring(s2, ~1, 0); "WRONG") 
			      handle Subscript => "OK" | _ => "WRONG");
val test12c = tst0 "test12c" ((substring(s2, 11, 0); "WRONG") 
			      handle Subscript => "OK" | _ => "WRONG");
val test12d = tst0 "test12d" ((substring(s2, 0, 11); "WRONG") 
			      handle Subscript => "OK" | _ => "WRONG");
val test12e = tst0 "test12e" ((substring(s2, 10, 1); "WRONG") 
			      handle Subscript => "OK" | _ => "WRONG");
val test12f = 
    tst' "test12f" (fn _ => 
