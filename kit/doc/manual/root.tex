...
passionately about it).\footnote{The source file for the life program
  is \boxml{kitdemo/life.sml}\index{life@\texttt{life}}. Running
...
that the largest regions are \boxml{r94613} and \boxml{r94231}. To
...
the command-line, try executing \boxml{kit -help}. The output of
...
\boxml{merge} allocates a list cell (two words) but de-allocates
...
%\nocite{total97,total94,btv96,elshal95,KochHojfeld96,ElsmanICFP99,ElsmanThesis,ElsmanTIC98,H96,hallenberg99}
...
\label{kithelp}
%---------------------------------------------------------
This appendix shows the output of executing \boxml{kit -help}, where
\boxml{kit} is the version of the ML Kit compiler that uses the x86
