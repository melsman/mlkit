...
sig
      ...
      type effectvar
        sharing type effectvar = Effect.effect 
      type effect (* = ateff list *)
      type arroweffect (* = effectvar * effect *)
      type ateffect
        sharing type ateffect = Effect.effect
      ...
      val placeof: qmularefset -> place
      val makearef:effectvar*mulef->mularef
      val makeqmularefset: place list*effectvar list* imp_mularefmap*place * Effect.cone -> 
			   qmularefset
