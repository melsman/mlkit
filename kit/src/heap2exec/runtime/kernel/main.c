...
// need to include kernel32.lib as well
#    include <windows.h>
#    define WIN32_BUFSIZE 2048
#  endif /* HACKED_STANDALONE */
extern void winsock_end (void);
#endif /* OPSYS_WIN32 */
...
PVT char	*ImageToLoad	/* the path name of the image file to load */
		    = DFLT_IMAGE;
...
#ifdef HACKED_STANDALONE
#ifdef OPSYS_WIN32
    /* artificial restriction on size of path returned */
    ImageToLoad = (char *) malloc (sizeof (char) * WIN32_BUFSIZE);
    GetModuleFileName (NULL,ImageToLoad,WIN32_BUFSIZE);
#else
    ImageToLoad = MLCmdName;
#endif /* OPSYS_WIN32 */
#endif /* HACKED_STANDALONE */
