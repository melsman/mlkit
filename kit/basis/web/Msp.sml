...
fun printseq Empty      = ()
  | printseq Nl         = (Web.Conn.write "\n"; ())
  | printseq ($ s)      = (Web.Conn.write s; ())
  | printseq ($$ ss)    = List.app (ignore o Web.Conn.write) ss
...
fun formvar s =
  case Web.Conn.getQuery()
    of SOME formvars => Web.Set.get(formvars, s)
     | NONE => NONE
