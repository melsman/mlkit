signature WEB_CACHE = 
  sig
    ...
    val memoizeTime  : ('a,'b) cache -> ('a -> ('b * Time.time option)) -> 'a -> 'b
    val memoizePartial : ('a,'b) cache -> ('a -> 'b option) -> 'a -> 'b option
    val memoizePartialTime  : ('a,'b) cache -> ('a -> ('b * Time.time option) option) ->
                               'a -> 'b option
