# ---------------------------------------------------------------------
# RPM Spec File for the ML Kit Version 3.2
# ---------------------------------------------------------------------
#
...
# specification file mlkit-3.2.spec to /usr/src/redhat/SPECS/ and 
# copy the file mlkit-3.2.tgz to /usr/src/redhat/SOURCES/. You are 
# now ready for the build:
#
#   $> cd /usr/src/redhat/SPECS
#   $> rpm -ba mlkit-3.2.spec
# 
# ---------------------------------------------------------------------
...
Source: http://www.diku.dk/research-groups/topps/activities/kit3/mlkit-3.2.tgz
