...
[tan x] These return the sine, cosine, and tangent, respectively, of
...
[acos x] These return the arc sine and arc cosine, respectively, of
...
[log10 r] These return the natural logarithm (base e) and decimal
...
[tanh x] These return the hyperbolic sine, hyperbolic cosine, and
