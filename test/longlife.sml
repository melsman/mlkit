...
local
  ...
  fun testit _ = (show(iter 200); show(iter 200); show(iter 200); show(iter 200); show(iter 200); show(iter 200); show(iter 200); show(iter 200); show(iter 200); show(iter 200); show(iter 200); show(iter 200); show(iter 200); show(iter 200); show(iter 200); show(iter 200); show(iter 200); show(iter 200))
