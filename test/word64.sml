...
fun checkrange bounds f = (check o range bounds) f handle _ => "EXN"
...
(* test/word.sml -- some test cases for Word32 and Word64 appropriate for a two's
   complement representation with Word.wordSize = 32
   PS 1995-03-19, 1995-07-12, 1995-11-06, 1996-04-01, 1996-10-01
   ME 2001-04-26, mael 2020-04-22
*)
