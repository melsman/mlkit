...
(* test/word16.sml -- some test cases for Word16 *)
...
in
val test1 = checkrange (0, 0xFFFF)
    (fn i => i = w2i (i2w i))
val _ = pr_ln "test1" test1
val test2 = checkrange (~100000, 100000)
    (fn i => let val r = w2i (i2w i)
	     in 0 <= r andalso r <= 0xFFFF end);
val _ = pr_ln "test2" test2
val test3 = checkrange (~0x8000, 0x7FFF)
    (fn i => i = toIntX (i2w i));
val _ = pr_ln "test3" test3
val test4 = checkrange (~100000, 100000)
    (fn i => let val r = toIntX (i2w i)
	     in ~0x8000 <= r andalso r < 0x8000 end);
...
val test5c = checkrange (~100000,100000)
    (fn i => let val r = w2i (andb (i2w 223047, i2w i))
	     in 0 <= r andalso r <= 0xFFFF end);
...
val test6c = checkrange (~100000,100000)
    (fn i => let val r = w2i (andb (i2w 207547, i2w i))
	     in 0 <= r andalso r <= 0xFFFF end);
...
val test7c = checkrange (~100000,100000)
    (fn i => let val r = w2i (xorb (i2w 0, i2w i))
	     in 0 <= r andalso r <= 0xFFFF end);
val _ = pr_ln "test7c" test7c
val test8a = check (0xFFFF = w2i (notb (i2w 0)));
val _ = pr_ln "test8a" test8a
val test8b = check (0 = w2i (notb (i2w 0xFFFF)));
val _ = pr_ln "test8b" test8b
val test8c = checkrange (~100000,100000)
...
val test9h = checkrange (16,65)
    (fn k => 0 = w2i (<< (i2w 0xFFFF, i2W k)));
...
val test10b = checkrange (1,50)
                         let val e = Word16.fromLarge 0wxFFFF
                         in (fn k =>
                                let val a = ~>> (e, i2W k)
                                in 0xFFFF = w2i a
                                end)
...
val test10d = checkrange (~0x8000, 0x7FFF)
    (fn i => i div 2 = toIntX (~>> (i2w i, i2W 1)));
val _ = pr_ln "test10d" test10d
val test10e = checkrange (0,65)
    (fn k => rwp ~0x8000 k = toIntX (~>> (i2w ~0x8000, i2W k)));
val _ = pr_ln "test10e" test10e
val test11a = check (Word16.>  (i2w 0xFFFF, i2w 0xFFFE));
val _ = pr_ln "test11a" test11a
val test11b = check (Word16.<  (i2w 0xFFFD, i2w 0xFFFE));
val _ = pr_ln "test11b" test11b
val test11c = check (Word16.>= (i2w 0x8000, i2w 0x8000));
val _ = pr_ln "test11c" test11c
val test11d = check (Word16.>= (i2w 0x8000, i2w 0x7FFF));
val _ = pr_ln "test11d" test11d
val test11e = check (Word16.<= (i2w 1,   i2w 1));
val _ = pr_ln "test11e" test11e
val test11f = check (Word16.<= (i2w 0,   i2w 1));
val _ = pr_ln "test11f" test11f

val test12a = check (w2i(Word16.+(i2w   5, i2w  10)) =  15);
val _ = pr_ln "test12a" test12a
val test12b = check (w2i(Word16.+(i2w 127, i2w  11)) = 138);
val _ = pr_ln "test12b" test12b
val test12c = check (w2i(Word16.+(i2w 65534, i2w   3)) =   1);
val _ = pr_ln "test12c" test12c
val test12d = check (w2i(Word16.-(i2w  10, i2w   3)) =   7);
val _ = pr_ln "test12d" test12d
val test12e = check (w2i(Word16.-(i2w 138, i2w  11)) = 127);
val _ = pr_ln "test12e" test12e
val test12f = check (w2i(Word16.-(i2w   1, i2w   3)) = 65534);
val _ = pr_ln "test12f" test12f
val test12g = check (w2i(Word16.*(i2w   5, i2w  11)) =  55);
val _ = pr_ln "test12g" test12g
val test12h = check (w2i(Word16.*(i2w   4, i2w  35)) = 140);
val _ = pr_ln "test12h" test12h
val test12i = check (w2i(Word16.*(i2w   3, i2w 24333)) = 7463);
val _ = pr_ln "test12i" test12i
val test12j = check (w2i(Word16.div(i2w  10, i2w 3)) =   3);
val _ = pr_ln "test12j" test12j
val test12k = check (w2i(Word16.div(i2w 0xFFFF, i2w 1)) = 0xFFFF);
val _ = pr_ln "test12k" test12k
val test12l = check (w2i(Word16.div(i2w 242, i2w 3)) =  80);
val _ = pr_ln "test12l" test12l
val test12m = check (w2i(Word16.mod(i2w  10, i2w 3)) =   1);
val _ = pr_ln "test12m" test12m
val test12n = check (w2i(Word16.mod(i2w 0xFFFF, i2w 1)) =   0);
val _ = pr_ln "test12n" test12n
val test12o = check (w2i(Word16.mod(i2w 242, i2w 3)) =   2);
val _ = pr_ln "test12o" test12o
val test12p = (Word16.div(i2w 0, i2w 0x10000) seq "WRONG")
              handle Div => "OK" | _ => "WRONG";
val _ = pr_ln "test12p" test12p
val test12q = (Word16.mod(i2w 0, i2w 0x10000) seq "WRONG")
              handle Div => "OK" | _ => "WRONG";
...
val test13c = (fromString "10000" seq "WRONG")
...
val test14c = (StringCvt.scanString (scan StringCvt.DEC) "65536" seq "WRONG")
              handle Overflow => "OK" | _ => "WRONG";
...
val test15c = (StringCvt.scanString (scan StringCvt.BIN) "10000000000000000"
	       seq "WRONG")
              handle Overflow => "OK" | _ => "WRONG";
...
val test16c = (StringCvt.scanString (scan StringCvt.OCT) "200000" seq "WRONG")
              handle Overflow => "OK" | _ => "WRONGEXN";
val _ = pr_ln "test16c" test16c

val test16c' = (StringCvt.scanString (scan StringCvt.OCT) "177777" seq "OK")
              handle Overflow => "EXNOVFOK" | _ => "EXN";
val _ = pr_ln "test16c'" test16c'
...
val test17c = (StringCvt.scanString (scan StringCvt.HEX) "10000" seq "WRONG")
              handle Overflow => "OK" | _ => "WRONG";
...
val test23 =
    check'(fn () => range (0, 255) (fn i =>
                                       let val lw = LargeWord.fromInt i
                                       in Word16.fromLarge lw = Word16.fromInt i
                                       end))
val _ = pr_ln "test23" test23

val test24 =
    check'(fn () => let val lw = LargeWord.fromInt ~1
                    in Word16.fromLarge lw = Word16.fromInt 0xFFFF
                    end)
val _ = pr_ln "test24" test24
