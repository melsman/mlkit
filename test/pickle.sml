...
*)
    ...
    fun w32_to_w31 w = (Word31.fromLargeWord o Word32.toLargeWord) w
    fun w31_to_w32 w = (Word32.fromLargeWord o Word31.toLargeWord) w
    ...
    val word31 = wordGen "word" (w31_to_w32, w32_to_w31)
    val word32 = wordGen "word32" (fn x => x, fn x => x)
    val int = wordGen "int" (Word32.fromInt, Word32.toIntX)
    val int31 = wordGen "int31" (Word32.fromLargeInt o Int31.toLarge,
				 Int31.fromLarge o Word32.toLargeIntX)
