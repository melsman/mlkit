...
local 
    ...
    val longstring = dup 5 "abc\000\001\002\003\255"  (* was 16 but because `limit stack` = 8192 kbytes on frigg
...
val _ = print ("fileSize(medium.dat) = " ^ Int.toString (fileSize "medium.dat") ^ "; size(longstring) = " ^ Int.toString (size longstring) ^ "\n")
