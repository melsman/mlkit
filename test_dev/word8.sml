...
val _ = pr_ln "test12b" (Int.toString (w2i(Word8.+(i2w 127, i2w  11))))
val _ = pr_ln "test12b" (Int.toString (w2i(Word8.+(i2w 128, i2w 11))))
...
val _ = pr_ln "test12d" (Int.toString (w2i(Word8.-(i2w  10, i2w   3))))
