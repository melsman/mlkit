functor BackendInfoPAML(structure Labels : ADDRESS_LABELS
			structure Lvars : LVARS
			structure Lvarset: LVARSET
			sharing type Lvarset.lvar = Lvars.lvar
			structure InstsPAML : INSTS_PAML
			sharing type InstsPAML.lvar = Lvars.lvar
  ...
  struct
    ...
    structure I = InstsPAML

    fun die s  = Crash.impossible ("BackendInfoPAML." ^ s)
     ...
     * code in HpPaRisc/BackendInfo.sml; 17/01-2000, Niels *)
    ...
    val regionPageTotalSize = 63 (*ALLOCATABLE_WORDS_IN_REGION_PAGE*) + 1 (*HEADER_WORDS_IN_REGION_PAGE*)
    val regionPageHeaderSize = 1 (*HEADER_WORDS_IN_REGION_PAGE*)
    ...
    val exn_MEMORY_lab    = Labels.new_named("exp_MEMORY_lab")
    ...
    (* The rest of the code is copied from HpPaRisc/BackendInfo.sml; 17/01-2000, Niels *)
    ...
    val down_growing_stack : bool = true         (* true for PAML code generation *)
    val double_alignment_required : bool = false (* false for PAML code generation *)
