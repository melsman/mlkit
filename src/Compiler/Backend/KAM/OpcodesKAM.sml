...
functor OpcodesKAM () : OPCODES_KAM = 
  struct
    ...
    val PUSH_EXN_PTR = 49
    val POP_EXN_PTR = 50
    val GLOBAL_EXN_HANDLER_REPORT = 51
    val LETREGION_FIN = 52
    val LETREGION_INF = 53
    val ENDREGION_INF = 54
    val RESET_REGION = 55
    val MAYBE_RESET_REGION = 56
    val RESET_REGION_IF_INF = 57
    val FETCH_DATA = 58
    val STORE_DATA = 59
    val HALT = 60
    val PRIM_EQUAL_I = 61
    ...
    val PRIM_NEG_F = 69
    val PRIM_ABS_F = 70
    val PRIM_LESS_THAN = 71
    val PRIM_LESS_EQUAL = 72
    val PRIM_GREATER_THAN = 73
    val PRIM_GREATER_EQUAL = 74
    val PRIM_LESS_THAN_UNSIGNED = 75
    val PRIM_GREATER_THAN_UNSIGNED = 76
    val PRIM_LESS_EQUAL_UNSIGNED = 77
    val PRIM_GREATER_EQUAL_UNSIGNED = 78
    val PRIM_ADD_W8 = 79
    val PRIM_SUB_W8 = 80
    val PRIM_AND_I = 81
    val PRIM_OR_I = 82
    val PRIM_XOR_I = 83
    val PRIM_SHIFT_LEFT_I = 84
    val PRIM_SHIFT_RIGHT_SIGNED_I = 85
    val PRIM_SHIFT_RIGHT_UNSIGNED_I = 86
    val PRIM_ADD_W = 87
    val PRIM_SUB_W = 88
    val PRIM_FRESH_EXNAME = 89
  end
