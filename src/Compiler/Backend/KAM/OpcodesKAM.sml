...
functor OpcodesKAM () : OPCODES_KAM = 
  struct
    ...
    val PRIM_NEG_F = 67
    val PRIM_ABS_F = 68
    val PRIM_LESS_THAN = 69
    val PRIM_LESS_EQUAL = 70
    val PRIM_GREATER_THAN = 71
    val PRIM_GREATER_EQUAL = 72
    val PRIM_LESS_THAN_UNSIGNED = 73
    val PRIM_GREATER_THAN_UNSIGNED = 74
    val PRIM_LESS_EQUAL_UNSIGNED = 75
    val PRIM_GREATER_EQUAL_UNSIGNED = 76
    val PRIM_ADD_W8 = 77
    val PRIM_SUB_W8 = 78
    val PRIM_AND_I = 79
    val PRIM_OR_I = 80
    val PRIM_XOR_I = 81
    val PRIM_SHIFT_LEFT_I = 82
    val PRIM_SHIFT_RIGHT_SIGNED_I = 83
    val PRIM_SHIFT_RIGHT_UNSIGNED_I = 84
    val PRIM_ADD_W = 85
    val PRIM_SUB_W = 86
    val PRIM_FRESH_EXNAME = 87
  end
