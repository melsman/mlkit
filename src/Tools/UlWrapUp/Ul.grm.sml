...
\\029\000\000\000\
\\030\000\007\000\006\000\008\000\005\000\009\000\004\000\000\000\
\\031\000\000\000\
\\032\000\000\000\
\\033\000\000\000\
\\034\000\001\000\012\000\000\000\
\\035\000\000\000\
\\036\000\002\000\010\000\000\000\
\\037\000\000\000\
\\038\000\002\000\008\000\000\000\
\\038\000\002\000\008\000\005\000\015\000\000\000\
\\039\000\000\000\
\\040\000\000\000\
\"
val actionRowNumbers =
"\009\000\008\000\017\000\015\000\
\\013\000\003\000\018\000\004\000\
\\015\000\005\000\006\000\009\000\
\\020\000\001\000\009\000\016\000\
\\009\000\002\000\012\000\017\000\
\\011\000\010\000\000\000\019\000\
\\013\000\014\000\007\000"
val gotoT =
"\
...
datatype svalue = VOID | ntVOID of unit ->  unit
 ...
 | SmlInclude of unit ->  ( ( UF.uofile * UF.location option )  list)
...
MlyValue.SmlInclude (fn _ => let val  (UOFILE as UOFILE1) = UOFILE1 ()
 ...
 in ( (UOFILE,SOME SML)::SmlInclude )
end)
 in ( LrTable.NT 4, ( result, UOFILE1left, SmlInclude1right), rest671)

end
|  ( 11, ( ( _, ( MlyValue.SmlInclude SmlInclude1, _, SmlInclude1right
)) :: ( _, ( MlyValue.UOFILE UOFILE1, UOFILE1left, _)) :: rest671)) =>
 let val  result = MlyValue.SmlInclude (fn _ => let val  (UOFILE as 
UOFILE1) = UOFILE1 ()
 val  (SmlInclude as SmlInclude1) = SmlInclude1 ()
 in ( (UOFILE,NONE)::SmlInclude )
end)
 in ( LrTable.NT 4, ( result, UOFILE1left, SmlInclude1right), rest671)
