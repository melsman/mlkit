...
signature MANAGER_OBJECTS =
  sig
    ...
    type absprjid  (* Absolute project identifiers; project identifiers with
		    * absolute path information (e.g., /home/mael/kit/basislib/basislib.pm). *)
	...
	val mk_exe : absprjid * modcode * string list * string -> unit  (* produces executable `string' in target directory *)
