...
(*	 val B = doUnpickleBases unitname ;mael 2004-03-10 *)
...
(*       ; exportRep() *)
	...
	let fun wrong s = WRONG_FILETYPE ("File name must have extension '.pm', '.mlb', '.sml', or '.sig'.\n" ^
	...
	in case OS.Path.ext s of 
	  ...
	  | SOME "pm" => PM s
	  | SOME "mlb" => MLB s
	  | SOME ext => wrong ("extension " ^ quot ext ^ ".")
