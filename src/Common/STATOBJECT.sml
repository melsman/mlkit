  ...
  sig
    ...
    structure Type :
      sig
        ...
        val fresh_normal            : unit -> Type               (* A fresh tyvar *)
        val tyvars                  : Type -> TyVar list
        val tynames                 : Type -> TyName.Set.Set
        val string                  : Type -> string
        val string_repl             : Type -> string             (* For type-indexed value printing in the REPL *)
        ...
        val contains_row_variable   : Type -> bool               (* true iff row variable the type *)
        val add_regvars             : ParseInfo.ParseInfo * regvar_info list -> Type -> Type
                                                                 (* Raises Fail msg on error *)
    ...
    structure TypeFcn :
      sig
        ...
        (* The function pretty_string returns three strings. This is because
           something like
           ...
           For ReML, the second string represents region and effect parameters,
           which are printed to the right of the type name. That is,

            type ('a, 'b) Bar `r = (int*int)`r

           maps Bar to "/\('a, 'b) `r. (int*int)`r"
         *)
