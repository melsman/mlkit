...
local
  fun member x a = List.exists (fn y => a = y) x
  ...
  fun occurs3 x =
      ...
      let fun f q =
          ...
          fun diff x y = List.filter (not o (member y)) x
  ...
  fun gun () =
      mkgen [(2,20),(3,19),(3,21),(4,18),(4,22),(4,23),(4,32),(5,7),(5,8),(5,18),
  ...
  fun show x = List.app (fn s => (print s; print "\n")) (plot(alive x));
    ...
    fun nthgen (p as(0,g)) = p
      | nthgen (p as(i,g)) =
        nthgen (i-1, let val g' = nextgen g
                     in show g;
                        (*resetRegions g;*) (* resetRegions g can be omitted here, since *)
