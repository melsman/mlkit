...
structure SMLserverDbBasicOra : SMLSERVER_DB_BASIC =
  struct
...
structure SMLserverDbBasicPG : SMLSERVER_DB_BASIC =
  struct
...
structure SMLserverDbBasicMySQL : SMLSERVER_DB_BASIC =
  struct
