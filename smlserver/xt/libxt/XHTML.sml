...
signature XHTML =
	...
	(* Input elements *)
	val inputText      : ('n,'t)fname -> 't var option -> ('n->'x,'x,'a,'p,inline flow) felt
	val inputTexta     : ('a1, 'a2, na,na, A.disabled,'a3, A.readonly,'a4, 
			      A.size,'a5, na,na, na,na) A.attr
	                     -> ('n,'t)fname -> 't var option -> ('n->'x,'x,'a,'p,inline flow) felt

	val inputPassword  : ('n,'t)fname -> 't var option -> ('n->'x,'x,'a,'p,inline flow) felt
	val inputPassworda : ('a1, 'a2, na,na, A.disabled,'a3, A.readonly,'a4, 
			      A.size,'a5, na,na, na,na) A.attr
	                     -> ('n,'t)fname -> 't var option -> ('n->'x,'x,'a,'p,inline flow) felt

	val inputRadio     : ('n,'t option)fname -> 't var -> ('n rad->'x,'x,'a,'p,inline flow) felt
	val inputRadioa    : ('a1, 'a2, A.checked,'a3, A.disabled,'a4, A.readonly,'a5, 
			      na,na, na,na, na,na)A.attr
	                     -> ('n,'t option)fname -> 't var -> ('n rad->'x,'x,'a,'p,inline flow) felt

	val inputRadio'    : ('n,'t option)fname -> 't var -> ('n rad->'x,'n rad->'x,'a,'p,inline flow) felt
	val inputRadioa'   : ('a1, 'a2, A.checked,'a3, A.disabled,'a4, A.readonly,'a5, 
			      na,na, na,na, na,na)A.attr
	                     -> ('n,'t option)fname -> 't var -> ('n rad->'x,'n rad->'x,'a,'p,inline flow) felt

	val radioDrop      : ('n rad->'x,'y,'a,'p,'k) felt -> ('n->'x,'y,'a,'p,'k) felt

	type 'a checkbox

	val inputCheckbox  : ('n,'t list)fname -> 't var -> ('n checkbox->'x,'x,'a,'p,inline flow) felt
	val inputCheckboxa : ('a1, 'a2, A.checked,'a3, A.disabled,'a4, A.readonly,'a5, 
			      na,na, na,na, na,na)A.attr
	                     -> ('n,'t list)fname -> 't var -> ('n checkbox->'x,'x,'a,'p,inline flow) felt

	val inputCheckbox' : ('n,'t list)fname -> 't var -> ('n checkbox->'x,'n checkbox->'x,'a,'p,inline flow) felt
	val inputCheckboxa': ('a1, 'a2, A.checked,'a3, A.disabled,'a4, A.readonly,'a5, 
			      na,na, na,na, na,na)A.attr
	                     -> ('n,'t list)fname -> 't var -> ('n checkbox->'x,'n checkbox->'x,'a,'p,inline flow) felt

	val checkboxDrop   : ('n checkbox->'x,'y,'a,'p,'k) felt -> ('n->'x,'y,'a,'p,'k) felt

 	val inputHidden    : ('n,'t)fname -> 't var -> ('n->'x,'x,'a,'p,inline flow) felt
 	val inputHiddena   : ('a1,'a2,na,na,na,na,na,na,na,na,na,na,na,na) A.attr
	                     -> ('n,'t)fname -> 't var -> ('n->'x,'x,'a,'p,inline flow) felt

 	val inputSubmit    : string -> ('x,'x,'a,'p,inline flow) felt
 	val inputSubmita   : ('a1, 'a2, na,na, A.disabled,'a3, A.readonly,'a4, 
			      na,na, na,na, na,na)A.attr
	                     -> string -> ('x,'x,'a,'p,inline flow) felt
