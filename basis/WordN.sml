...
structure Word7 = WF(struct open Word8 val size = 7 end)
structure Word6 = WF(struct open Word8 val size = 6 end)
structure Word5 = WF(struct open Word8 val size = 5 end)
structure Word4 = WF(struct open Word8 val size = 4 end)
structure Word3 = WF(struct open Word8 val size = 3 end)
structure Word2 = WF(struct open Word8 val size = 2 end)
structure Word1 = WF(struct open Word8 val size = 1 end)
