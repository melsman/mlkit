...
concat l
    ...
    is the concatenation of all the slices in l. This raises Size if
    the sum of all the lengths is greater than Vector.maxLen.
...
map f sl
    ...
    slice to the function f. The first expression is equivalent to:
